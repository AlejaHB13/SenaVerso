...
export default function Home() {
  ...
  <div className="flex items-center justify-center mb-8">
    <div className="mr-8">
      <Image src="/pirata.png" alt="Pirata" width={280} height={280} />
    </div>
    <div className="bg-yellow-400 text-white font-semibold text-center rounded-lg p-4 shadow-lg text-2xl">
      Ayúdame a encontrar el tesoro en la isla del ABC
    </div>
  </div>

  <div className="flex gap-8 justify-center">
    <Link href="/actividad1" className="hover:scale-110 transition-transform">
      <Image src="/coin.png" alt="Actividad 1" width={120} height={120} />
    </Link>
    <Link href="/actividad2" className="hover:scale-110 transition-transform">
      <Image src="/coin.png" alt="Actividad 2" width={120} height={120} />
    </Link>
    <Link href="/actividad3" className="hover:scale-110 transition-transform">
      <Image src="/coin.png" alt="Actividad 3" width={120} height={120} />
    </Link>
  </div>
</div>
