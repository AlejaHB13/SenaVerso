    ...
    if (flipped.length === 2) {
      ...
      if (
        ...
        setCurrentPairMessage({
          ...
          image: "/flor.png", // Cambia esta imagen por la que desees mostrar
        }); // Mensaje genérico para todas las parejas
...
function MemoryCard({ card, flipped, onFlip }: MemoryCardProps) {
  ...
  return (
    <div className="flex">
      <div
        className={`w-24 h-24 border-2 rounded-lg flex items-center justify-center cursor-pointer bg-[#17a7e8] transition-all ${
